...
import { ThemeSwitcher, ThemePreview, ThemeTest, ThemeToggleDemo, ThemeComparison, ThemeDifferences } from "@/components/ui/theme"
  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          See the actual color values and understand why differences are subtle in light mode
        </p>
        <ThemeDifferences />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              ...
              <code className="text-sm bg-muted px-2 py-1 rounded">Inline code</code>
            </div>
          </Card>
      ...
      <div className="space-y-4">
        ...
        <Card className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm font-mono">
            <div className="space-y-2">
              <div className="text-xs text-muted-foreground">Background Colors</div>
              ...
              <div>--card: <span className="text-primary">var(--card)</span></div>
              <div>--popover: <span className="text-primary">var(--popover)</span></div>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              <div className="text-xs text-muted-foreground">Utility Colors</div>
              ...
              <div>--input: <span className="text-primary">var(--input)</span></div>
              <div>--ring: <span className="text-primary">var(--ring)</span></div>
            </div>
          </div>
        </Card>
      </div>
