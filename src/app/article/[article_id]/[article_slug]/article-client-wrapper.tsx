...
/**
 * Article Client Wrapper Component
 * Handles all client-side interactions for the article page
 * Receives initial article data from the server component
 */
export function ArticleClientWrapper({
  ...
  // Use the article hook with initial data
  const {
    data: article,
    isLoading,
    error,
