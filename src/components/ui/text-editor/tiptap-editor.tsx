             ...
             <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-48">
                <DropdownMenuItem onClick={handleAlignLeft} className="flex items-center gap-2">
                  ...
                  {currentAlignment === 'left' && <span className="ml-auto text-xs text-primary">✓</span>}
                </DropdownMenuItem>
                <DropdownMenuItem onClick={handleAlignCenter} className="flex items-center gap-2">
                  <AlignCenter className="h-4 w-4" />
                  <span>Align Center</span>
                  {currentAlignment === 'center' && <span className="ml-auto text-xs text-primary">✓</span>}
                </DropdownMenuItem>
                <DropdownMenuItem onClick={handleAlignRight} className="flex items-center gap-2">
                  <AlignRight className="h-4 w-4" />
                  <span>Align Right</span>
                  {currentAlignment === 'right' && <span className="ml-auto text-xs text-primary">✓</span>}
                </DropdownMenuItem>
                <DropdownMenuItem onClick={handleAlignJustify} className="flex items-center gap-2">
                  <AlignJustify className="h-4 w-4" />
                  <span>Justify</span>
                  {currentAlignment === 'justify' && <span className="ml-auto text-xs text-primary">✓</span>}
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
